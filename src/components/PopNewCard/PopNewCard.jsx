...
function PopNewCard() {
  ...
  const handleCreate = () => {
    ...
    // ...
    navigate(-1); // Возврат после создания
  };
  return (
    <>
        ...
        <PopNewCardWrapper>
          <PopNewCardBlock>
            <PopNewCardContent>
              ...
              {/* Меняем ссылку на функцию закрытия */}
                  ...
                  <CalendarBlock>
                    ...
                    <CalendarContent>
                      ...
                      <CalendarCells>
                        ...
                        <CalendarCell className="_cell-day _weekend">
                          2
                        </CalendarCell>
                        <CalendarCell className="_cell-day _weekend">
                          3
                        ...
                        <CalendarCell className="_cell-day _current">
                          8
                        </CalendarCell>
                        <CalendarCell className="_cell-day _weekend">
                          9
                        ...
                        <CalendarCell className="_other-month _weekend">
                          1
                        </CalendarCell>
                      </CalendarCells>
                    </CalendarContent>
